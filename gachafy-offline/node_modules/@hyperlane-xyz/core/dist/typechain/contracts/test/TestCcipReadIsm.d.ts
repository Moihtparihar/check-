...
export interface TestCcipReadIsmInterface extends utils.Interface {
    functions: {
        ...
        "receivedMessages()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "getOffchainVerifyInfo" | "getOffchainVerifyInfo(bytes)" | "handle" | "handle(uint32,bytes32,bytes)" | "moduleType" | "moduleType()" | "owner" | "owner()" | "receivedMessages" | "receivedMessages()" | "renounceOwnership" | "renounceOwnership()" | "setUrls" | "setUrls(string[])" | "transferOwnership" | "transferOwnership(address)" | "urls" | "urls()" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "owner()", values?: undefined): string;
    encodeFunctionData(functionFragment: "receivedMessages", values?: undefined): string;
    encodeFunctionData(functionFragment: "receivedMessages()", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "owner()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "receivedMessages", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "receivedMessages()", data: BytesLike): Result;
    ...
    events: {
        ...
        "ReceivedMessage(uint32,bytes32,uint256,bytes)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "ReceivedMessage(uint32,bytes32,uint256,bytes)"): EventFragment;
...
export interface TestCcipReadIsm extends BaseContract {
    ...
    functions: {
        ...
        handle(_origin: BigNumberish, _sender: BytesLike, _messageBody: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "handle(uint32,bytes32,bytes)"(_origin: BigNumberish, _sender: BytesLike, _messageBody: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "owner()"(overrides?: CallOverrides): Promise<[string]>;
        receivedMessages(overrides?: CallOverrides): Promise<[number]>;
        "receivedMessages()"(overrides?: CallOverrides): Promise<[number]>;
        ...
        "urls()"(overrides?: CallOverrides): Promise<[string[]]>;
        verify(arg0: BytesLike, arg1: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "verify(bytes,bytes)"(arg0: BytesLike, arg1: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    PACKAGE_VERSION(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        getOffchainVerifyInfo(_message: BytesLike, overrides?: CallOverrides): Promise<void>;
        "getOffchainVerifyInfo(bytes)"(_message: BytesLike, overrides?: CallOverrides): Promise<void>;
        handle(_origin: BigNumberish, _sender: BytesLike, _messageBody: BytesLike, overrides?: CallOverrides): Promise<void>;
        "handle(uint32,bytes32,bytes)"(_origin: BigNumberish, _sender: BytesLike, _messageBody: BytesLike, overrides?: CallOverrides): Promise<void>;
        moduleType(overrides?: CallOverrides): Promise<number>;
        "moduleType()"(overrides?: CallOverrides): Promise<number>;
        owner(overrides?: CallOverrides): Promise<string>;
        "owner()"(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        ...
        "ReceivedMessage(uint32,bytes32,uint256,bytes)"(origin?: BigNumberish | null, sender?: BytesLike | null, value?: BigNumberish | null, message?: null): ReceivedMessageEventFilter;
    ...
    estimateGas: {
        ...
        "owner()"(overrides?: CallOverrides): Promise<BigNumber>;
        receivedMessages(overrides?: CallOverrides): Promise<BigNumber>;
        "receivedMessages()"(overrides?: CallOverrides): Promise<BigNumber>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "owner()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        receivedMessages(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "receivedMessages()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=TestCcipReadIsm.d.ts.map