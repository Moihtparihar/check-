...
export interface XERC20TestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_decimals" | "_decimals()" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(address,uint256)" | "burnFrom" | "burnFrom(address,uint256)" | "burningCurrentLimitOf" | "burningCurrentLimitOf(address)" | "burningMaxLimitOf" | "burningMaxLimitOf(address)" | "decimals" | "decimals()" | "decreaseAllowance" | "decreaseAllowance(address,uint256)" | "increaseAllowance" | "increaseAllowance(address,uint256)" | "initialize" | "initialize()" | "mint(address,uint256)" | "mint(uint256)" | "mintTo" | "mintTo(address,uint256)" | "mintingCurrentLimitOf" | "mintingCurrentLimitOf(address)" | "mintingMaxLimitOf" | "mintingMaxLimitOf(address)" | "name" | "name()" | "owner" | "owner()" | "renounceOwnership" | "renounceOwnership()" | "setLimits" | "setLimits(address,uint256,uint256)" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)" | "transferOwnership" | "transferOwnership(address)"): FunctionFragment;
