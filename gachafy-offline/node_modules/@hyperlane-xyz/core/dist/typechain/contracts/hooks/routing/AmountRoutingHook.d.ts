...
export interface AmountRoutingHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "hookType" | "hookType()" | "lower" | "lower()" | "postDispatch" | "postDispatch(bytes,bytes)" | "quoteDispatch" | "quoteDispatch(bytes,bytes)" | "supportsMetadata" | "supportsMetadata(bytes)" | "threshold" | "threshold()" | "upper" | "upper()"): FunctionFragment;
...
//# sourceMappingURL=AmountRoutingHook.d.ts.map