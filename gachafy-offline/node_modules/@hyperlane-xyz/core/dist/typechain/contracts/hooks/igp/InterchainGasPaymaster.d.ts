...
export interface InterchainGasPaymaster extends BaseContract {
    ...
    functions: {
        ...
        "deployedBlock()"(overrides?: CallOverrides): Promise<[BigNumber]>;
        destinationGasConfigs(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber
        ] & {
            gasOracle: string;
        ...
        "destinationGasConfigs(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            BigNumber
        ] & {
            gasOracle: string;
    ...
    estimateGas: {
        ...
        deployedBlock(overrides?: CallOverrides): Promise<BigNumber>;
        "deployedBlock()"(overrides?: CallOverrides): Promise<BigNumber>;
        destinationGasConfigs(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "destinationGasConfigs(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        destinationGasLimit(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "destinationGasLimit(uint32,uint256)"(_destinationDomain: BigNumberish, _gasLimit: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        "deployedBlock()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        destinationGasConfigs(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "destinationGasConfigs(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
