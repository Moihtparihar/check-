...
export interface CCIPHookInterface extends utils.Interface {
    ...
    decodeFunctionResult(functionFragment: "PACKAGE_VERSION()", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ccipDestination", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ccipDestination()", data: BytesLike): Result;
...
//# sourceMappingURL=CCIPHook.d.ts.map