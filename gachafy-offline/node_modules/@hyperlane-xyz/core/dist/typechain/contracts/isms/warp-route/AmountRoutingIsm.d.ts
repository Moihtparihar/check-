...
export interface AmountRoutingIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "lower" | "lower()" | "moduleType" | "moduleType()" | "route" | "route(bytes)" | "threshold" | "threshold()" | "upper" | "upper()" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
...
//# sourceMappingURL=AmountRoutingIsm.d.ts.map