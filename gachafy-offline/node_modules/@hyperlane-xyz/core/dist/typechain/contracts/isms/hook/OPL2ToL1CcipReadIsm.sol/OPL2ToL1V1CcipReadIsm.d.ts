...
export interface OPL2ToL1V1CcipReadIsmInterface extends utils.Interface {
    functions: {
...
export interface OPL2ToL1V1CcipReadIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OPL2ToL1V1CcipReadIsmInterface;
...
//# sourceMappingURL=OPL2ToL1V1CcipReadIsm.d.ts.map