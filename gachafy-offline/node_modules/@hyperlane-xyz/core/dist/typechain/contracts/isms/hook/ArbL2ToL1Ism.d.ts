...
export interface ArbL2ToL1IsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "arbOutbox" | "arbOutbox()" | "authorizedHook" | "authorizedHook()" | "isVerified" | "isVerified(bytes)" | "moduleType" | "moduleType()" | "preVerifyMessage" | "preVerifyMessage(bytes32,uint256)" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
