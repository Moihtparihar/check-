...
export interface CCIPIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "VERIFIED_MASK_INDEX" | "VERIFIED_MASK_INDEX()" | "authorizedHook" | "authorizedHook()" | "ccipOrigin" | "ccipOrigin()" | "ccipReceive" | "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))" | "getRouter" | "getRouter()" | "isVerified" | "isVerified(bytes)" | "moduleType" | "moduleType()" | "preVerifyMessage" | "preVerifyMessage(bytes32,uint256)" | "setAuthorizedHook" | "setAuthorizedHook(bytes32)" | "supportsInterface" | "supportsInterface(bytes4)" | "verifiedMessages" | "verifiedMessages(bytes32)" | "verify" | "verify(bytes,bytes)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "authorizedHook()", values?: undefined): string;
    encodeFunctionData(functionFragment: "ccipOrigin", values?: undefined): string;
    encodeFunctionData(functionFragment: "ccipOrigin()", values?: undefined): string;
    encodeFunctionData(functionFragment: "ccipReceive", values: [Client.Any2EVMMessageStruct]): string;
    encodeFunctionData(functionFragment: "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))", values: [Client.Any2EVMMessageStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))", data: BytesLike): Result;
...
export interface CCIPIsm extends BaseContract {
    ...
    functions: {
        ...
        "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))"(message: Client.Any2EVMMessageStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        verifiedMessages(messageId: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            verifiedAndValue: BigNumber;
        }>;
        "verifiedMessages(bytes32)"(messageId: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            verifiedAndValue: BigNumber;
        }>;
    ...
    callStatic: {
        ...
        "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))"(message: Client.Any2EVMMessageStruct, overrides?: CallOverrides): Promise<void>;
        getRouter(overrides?: CallOverrides): Promise<string>;
        "getRouter()"(overrides?: CallOverrides): Promise<string>;
        isVerified(message: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "isVerified(bytes)"(message: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    populateTransaction: {
        ...
        verifiedMessages(messageId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "verifiedMessages(bytes32)"(messageId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        verify(arg0: BytesLike, message: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "verify(bytes,bytes)"(arg0: BytesLike, message: BytesLike, overrides?: Overrides & {
...
//# sourceMappingURL=CCIPIsm.d.ts.map