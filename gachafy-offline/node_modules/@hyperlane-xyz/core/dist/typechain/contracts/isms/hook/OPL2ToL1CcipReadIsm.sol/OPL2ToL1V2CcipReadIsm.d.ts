...
export interface OPL2ToL1V2CcipReadIsmInterface extends utils.Interface {
    functions: {
...
export interface OPL2ToL1V2CcipReadIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OPL2ToL1V2CcipReadIsmInterface;
...
//# sourceMappingURL=OPL2ToL1V2CcipReadIsm.d.ts.map