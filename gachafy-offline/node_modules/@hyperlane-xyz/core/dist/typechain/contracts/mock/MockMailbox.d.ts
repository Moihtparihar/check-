...
export interface MockMailboxInterface extends utils.Interface {
    functions: {
        ...
        "addInboundMetadata(uint32,bytes)": FunctionFragment;
        ...
        "inboundMetadata(uint256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "addInboundMetadata", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "addInboundMetadata(uint32,bytes)", values: [BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "inboundMetadata", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "inboundMetadata(uint256)", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "addInboundMetadata", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "addInboundMetadata(uint32,bytes)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "inboundMetadata", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "inboundMetadata(uint256)", data: BytesLike): Result;
...
export interface MockMailbox extends BaseContract {
    ...
    functions: {
        ...
        addInboundMetadata(_nonce: BigNumberish, metadata: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "addInboundMetadata(uint32,bytes)"(_nonce: BigNumberish, metadata: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        inboundMessages(nonce: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            message: string;
        }>;
        "inboundMessages(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            message: string;
        }>;
        inboundMetadata(nonce: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            metadata: string;
        }>;
        "inboundMetadata(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            metadata: string;
        }>;
    ...
    callStatic: {
        ...
        addInboundMetadata(_nonce: BigNumberish, metadata: BytesLike, overrides?: CallOverrides): Promise<void>;
        "addInboundMetadata(uint32,bytes)"(_nonce: BigNumberish, metadata: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        inboundMessages(nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "inboundMessages(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        inboundMetadata(nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "inboundMetadata(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        inboundMessages(nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "inboundMessages(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        inboundMetadata(nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "inboundMetadata(uint256)"(nonce: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
