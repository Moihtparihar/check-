...
export interface OpL1V2NativeTokenBridgeInterface extends utils.Interface {
    functions: {
...
export interface OpL1V2NativeTokenBridge extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OpL1V2NativeTokenBridgeInterface;
...
//# sourceMappingURL=OpL1V2NativeTokenBridge.d.ts.map