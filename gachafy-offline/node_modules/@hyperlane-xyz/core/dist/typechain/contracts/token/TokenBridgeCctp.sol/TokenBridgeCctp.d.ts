...
export declare namespace TokenBridgeCctp {
    type DomainStruct = {
        hyperlane: BigNumberish;
        circle: BigNumberish;
    };
    type DomainStructOutput = [number, number] & {
        hyperlane: number;
        circle: number;
    };
}
...
export interface TokenBridgeCctpInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "PACKAGE_VERSION" | "PACKAGE_VERSION()" | "addBridge" | "addBridge(uint32,address)" | "addDomain" | "addDomain(uint32,uint32)" | "addDomains" | "addDomains((uint32,uint32)[])" | "addRebalancer" | "addRebalancer(address)" | "allowedBridges" | "allowedBridges(uint32)" | "allowedRebalancers" | "allowedRebalancers()" | "allowedRecipient" | "allowedRecipient(uint32)" | "approveTokenForBridge" | "approveTokenForBridge(address,address)" | "balanceOf" | "balanceOf(address)" | "destinationGas" | "destinationGas(uint32)" | "domains" | "domains()" | "enrollRemoteRouter" | "enrollRemoteRouter(uint32,bytes32)" | "enrollRemoteRouters" | "enrollRemoteRouters(uint32[],bytes32[])" | "getOffchainVerifyInfo" | "getOffchainVerifyInfo(bytes)" | "handle" | "handle(uint32,bytes32,bytes)" | "hook" | "hook()" | "hyperlaneDomainToCircleDomain" | "hyperlaneDomainToCircleDomain(uint32)" | "initialize(address,address,string[])" | "initialize(address,address,address)" | "interchainSecurityModule" | "interchainSecurityModule()" | "localDomain" | "localDomain()" | "mailbox" | "mailbox()" | "messageTransmitter" | "messageTransmitter()" | "moduleType" | "moduleType()" | "owner" | "owner()" | "quoteGasPayment" | "quoteGasPayment(uint32)" | "quoteTransferRemote" | "quoteTransferRemote(uint32,bytes32,uint256)" | "rebalance" | "rebalance(uint32,uint256,address)" | "removeBridge" | "removeBridge(uint32,address)" | "removeRebalancer" | "removeRebalancer(address)" | "removeRecipient" | "removeRecipient(uint32)" | "renounceOwnership" | "renounceOwnership()" | "routers" | "routers(uint32)" | "scale" | "scale()" | "setDestinationGas(uint32,uint256)" | "setDestinationGas((uint32,uint256)[])" | "setHook" | "setHook(address)" | "setInterchainSecurityModule" | "setInterchainSecurityModule(address)" | "setRecipient" | "setRecipient(uint32,bytes32)" | "setUrls" | "setUrls(string[])" | "tokenMessenger" | "tokenMessenger()" | "transferOwnership" | "transferOwnership(address)" | "transferRemote(uint32,bytes32,uint256,bytes,address)" | "transferRemote(uint32,bytes32,uint256)" | "unenrollRemoteRouter" | "unenrollRemoteRouter(uint32)" | "unenrollRemoteRouters" | "unenrollRemoteRouters(uint32[])" | "urls" | "urls()" | "verify" | "verify(bytes,bytes)" | "wrappedToken" | "wrappedToken()"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "addBridge(uint32,address)", values: [BigNumberish, string]): string;
    ...
    encodeFunctionData(functionFragment: "addDomains", values: [TokenBridgeCctp.DomainStruct[]]): string;
    encodeFunctionData(functionFragment: "addDomains((uint32,uint32)[])", values: [TokenBridgeCctp.DomainStruct[]]): string;
    encodeFunctionData(functionFragment: "addRebalancer", values: [string]): string;
    encodeFunctionData(functionFragment: "addRebalancer(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "allowedBridges", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "allowedBridges(uint32)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "allowedRecipient(uint32)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "approveTokenForBridge", values: [string, string]): string;
    encodeFunctionData(functionFragment: "approveTokenForBridge(address,address)", values: [string, string]): string;
    ...
    encodeFunctionData(functionFragment: "initialize(address,address,string[])", values: [string, string, string[]]): string;
    ...
    encodeFunctionData(functionFragment: "quoteTransferRemote(uint32,bytes32,uint256)", values: [BigNumberish, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "rebalance", values: [BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "rebalance(uint32,uint256,address)", values: [BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "removeBridge", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "removeBridge(uint32,address)", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "removeRebalancer", values: [string]): string;
    encodeFunctionData(functionFragment: "removeRebalancer(address)", values: [string]): string;
    encodeFunctionData(functionFragment: "removeRecipient", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "removeRecipient(uint32)", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setRecipient(uint32,bytes32)", values: [BigNumberish, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "addBridge(uint32,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "addDomains", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "addDomains((uint32,uint32)[])", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "addRebalancer", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "addRebalancer(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedBridges", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "allowedBridges(uint32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "allowedRecipient(uint32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "approveTokenForBridge", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "approveTokenForBridge(address,address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "initialize(address,address,string[])", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "quoteTransferRemote(uint32,bytes32,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rebalance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rebalance(uint32,uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeBridge", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeBridge(uint32,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeRebalancer", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeRebalancer(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeRecipient", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "removeRecipient(uint32)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setRecipient(uint32,bytes32)", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "CollateralMoved(uint32,bytes32,uint256,address)"): EventFragment;
...
export interface TokenBridgeCctp extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TokenBridgeCctpInterface;
    ...
    functions: {
        ...
        "addBridge(uint32,address)"(domain: BigNumberish, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        addDomains(domains: TokenBridgeCctp.DomainStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "addDomains((uint32,uint32)[])"(domains: TokenBridgeCctp.DomainStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        addRebalancer(rebalancer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "addRebalancer(address)"(rebalancer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        allowedBridges(domain: BigNumberish, overrides?: CallOverrides): Promise<[string[]]>;
        "allowedBridges(uint32)"(domain: BigNumberish, overrides?: CallOverrides): Promise<[string[]]>;
        allowedRebalancers(overrides?: CallOverrides): Promise<[string[]]>;
        "allowedRebalancers()"(overrides?: CallOverrides): Promise<[string[]]>;
        allowedRecipient(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            recipient: string;
        }>;
        "allowedRecipient(uint32)"(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            recipient: string;
        }>;
        approveTokenForBridge(token: string, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "approveTokenForBridge(address,address)"(token: string, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "destinationGas(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
            gasLimit: BigNumber;
        }>;
        ...
        "hook()"(overrides?: CallOverrides): Promise<[string]>;
        hyperlaneDomainToCircleDomain(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<[number]>;
        "hyperlaneDomainToCircleDomain(uint32)"(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<[number]>;
        "initialize(address,address,string[])"(_hook: string, _owner: string, __urls: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        quoteTransferRemote(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<[QuoteStructOutput[]] & {
            quotes: QuoteStructOutput[];
        }>;
        "quoteTransferRemote(uint32,bytes32,uint256)"(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<[QuoteStructOutput[]] & {
            quotes: QuoteStructOutput[];
        }>;
        rebalance(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "rebalance(uint32,uint256,address)"(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        removeBridge(domain: BigNumberish, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "removeBridge(uint32,address)"(domain: BigNumberish, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        removeRebalancer(rebalancer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "removeRebalancer(address)"(rebalancer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        removeRecipient(domain: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "removeRecipient(uint32)"(domain: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "setRecipient(uint32,bytes32)"(domain: BigNumberish, recipient: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "urls()"(overrides?: CallOverrides): Promise<[string[]]>;
        verify(_metadata: BytesLike, _hyperlaneMessage: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "verify(bytes,bytes)"(_metadata: BytesLike, _hyperlaneMessage: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "addBridge(uint32,address)"(domain: BigNumberish, bridge: string, overrides?: CallOverrides): Promise<void>;
        ...
        addDomains(domains: TokenBridgeCctp.DomainStruct[], overrides?: CallOverrides): Promise<void>;
        "addDomains((uint32,uint32)[])"(domains: TokenBridgeCctp.DomainStruct[], overrides?: CallOverrides): Promise<void>;
        addRebalancer(rebalancer: string, overrides?: CallOverrides): Promise<void>;
        "addRebalancer(address)"(rebalancer: string, overrides?: CallOverrides): Promise<void>;
        allowedBridges(domain: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        "allowedBridges(uint32)"(domain: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        allowedRebalancers(overrides?: CallOverrides): Promise<string[]>;
        "allowedRebalancers()"(overrides?: CallOverrides): Promise<string[]>;
        ...
        "approveTokenForBridge(address,address)"(token: string, bridge: string, overrides?: CallOverrides): Promise<void>;
        balanceOf(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
        "balanceOf(address)"(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
        destinationGas(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "destinationGas(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        hyperlaneDomainToCircleDomain(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<number>;
        "hyperlaneDomainToCircleDomain(uint32)"(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<number>;
        "initialize(address,address,string[])"(_hook: string, _owner: string, __urls: string[], overrides?: CallOverrides): Promise<void>;
        ...
        quoteTransferRemote(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<QuoteStructOutput[]>;
        "quoteTransferRemote(uint32,bytes32,uint256)"(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<QuoteStructOutput[]>;
        rebalance(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: CallOverrides): Promise<void>;
        "rebalance(uint32,uint256,address)"(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: CallOverrides): Promise<void>;
        removeBridge(domain: BigNumberish, bridge: string, overrides?: CallOverrides): Promise<void>;
        "removeBridge(uint32,address)"(domain: BigNumberish, bridge: string, overrides?: CallOverrides): Promise<void>;
        removeRebalancer(rebalancer: string, overrides?: CallOverrides): Promise<void>;
        "removeRebalancer(address)"(rebalancer: string, overrides?: CallOverrides): Promise<void>;
        removeRecipient(domain: BigNumberish, overrides?: CallOverrides): Promise<void>;
        "removeRecipient(uint32)"(domain: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        "setRecipient(uint32,bytes32)"(domain: BigNumberish, recipient: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        urls(overrides?: CallOverrides): Promise<string[]>;
        "urls()"(overrides?: CallOverrides): Promise<string[]>;
        verify(_metadata: BytesLike, _hyperlaneMessage: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "verify(bytes,bytes)"(_metadata: BytesLike, _hyperlaneMessage: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        wrappedToken(overrides?: CallOverrides): Promise<string>;
        "wrappedToken()"(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        "allowedBridges(uint32)"(domain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        allowedRebalancers(overrides?: CallOverrides): Promise<BigNumber>;
        "allowedRebalancers()"(overrides?: CallOverrides): Promise<BigNumber>;
        allowedRecipient(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "allowedRecipient(uint32)"(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        approveTokenForBridge(token: string, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "approveTokenForBridge(address,address)"(token: string, bridge: string, overrides?: Overrides & {
        ...
        "hook()"(overrides?: CallOverrides): Promise<BigNumber>;
        hyperlaneDomainToCircleDomain(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "hyperlaneDomainToCircleDomain(uint32)"(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "initialize(address,address,string[])"(_hook: string, _owner: string, __urls: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        "initialize(address,address,address)"(_hook: string, _interchainSecurityModule: string, _owner: string, overrides?: Overrides & {
        ...
        quoteGasPayment(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteGasPayment(uint32)"(_destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        quoteTransferRemote(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        "quoteTransferRemote(uint32,bytes32,uint256)"(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        rebalance(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<BigNumber>;
        "rebalance(uint32,uint256,address)"(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
    ...
    populateTransaction: {
        ...
        "allowedBridges(uint32)"(domain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        allowedRebalancers(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "allowedRebalancers()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        allowedRecipient(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "allowedRecipient(uint32)"(routerDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        approveTokenForBridge(token: string, bridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "approveTokenForBridge(address,address)"(token: string, bridge: string, overrides?: Overrides & {
        ...
        "destinationGas(uint32)"(destinationDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        "hook()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hyperlaneDomainToCircleDomain(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "hyperlaneDomainToCircleDomain(uint32)"(_hyperlaneDomain: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "initialize(address,address,string[])"(_hook: string, _owner: string, __urls: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "initialize(address,address,address)"(_hook: string, _interchainSecurityModule: string, _owner: string, overrides?: Overrides & {
        ...
        quoteTransferRemote(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "quoteTransferRemote(uint32,bytes32,uint256)"(_destinationDomain: BigNumberish, _recipient: BytesLike, _amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        rebalance(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        "rebalance(uint32,uint256,address)"(domain: BigNumberish, amount: BigNumberish, bridge: string, overrides?: PayableOverrides & {
...
//# sourceMappingURL=TokenBridgeCctp.d.ts.map