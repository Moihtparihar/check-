...
export interface IXERC20VSInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addBridge" | "addBridge((uint112,uint128,address))" | "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(address,uint256)" | "burningCurrentLimitOf" | "burningCurrentLimitOf(address)" | "burningMaxLimitOf" | "burningMaxLimitOf(address)" | "lockbox" | "lockbox()" | "mint" | "mint(address,uint256)" | "mintingCurrentLimitOf" | "mintingCurrentLimitOf(address)" | "mintingMaxLimitOf" | "mintingMaxLimitOf(address)" | "rateLimits" | "rateLimits(address)" | "removeBridge" | "removeBridge(address)" | "setBufferCap" | "setBufferCap(address,uint256)" | "setRateLimitPerSecond" | "setRateLimitPerSecond(address,uint128)" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
...
export interface IXERC20VS extends BaseContract {
    ...
    functions: {
        addBridge(_newBridge: IXERC20VS.RateLimitMidPointInfoStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "addBridge((uint112,uint128,address))"(_newBridge: IXERC20VS.RateLimitMidPointInfoStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        addBridge(_newBridge: IXERC20VS.RateLimitMidPointInfoStruct, overrides?: CallOverrides): Promise<void>;
        "addBridge((uint112,uint128,address))"(_newBridge: IXERC20VS.RateLimitMidPointInfoStruct, overrides?: CallOverrides): Promise<void>;
        allowance(owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;
        "allowance(address,address)"(owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=IXERC20VS.d.ts.map