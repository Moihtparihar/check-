...
export interface IFiatTokenInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "burn" | "burn(uint256)" | "mint" | "mint(address,uint256)" | "minterAllowance" | "minterAllowance(address)" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "minterAllowance(address)", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "minterAllowance(address)", data: BytesLike): Result;
...
export interface IFiatToken extends BaseContract {
    ...
    functions: {
        ...
        minterAllowance(_minter: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        "minterAllowance(address)"(_minter: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        minterAllowance(_minter: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "minterAllowance(address)"(_minter: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
