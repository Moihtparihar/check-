...
export interface CCIPReceiverInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ccipReceive" | "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))" | "getRouter" | "getRouter()" | "supportsInterface" | "supportsInterface(bytes4)"): FunctionFragment;
...
//# sourceMappingURL=CCIPReceiver.d.ts.map