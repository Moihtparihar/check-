...
export interface IAny2EVMMessageReceiverInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ccipReceive" | "ccipReceive((bytes32,uint64,bytes,bytes,(address,uint256)[]))"): FunctionFragment;
...
//# sourceMappingURL=IAny2EVMMessageReceiver.d.ts.map