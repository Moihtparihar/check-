...
import type { MovableCollateralRouter, MovableCollateralRouterInterface } from "../../../../contracts/token/libs/MovableCollateralRouter.js";
export declare class MovableCollateralRouter__factory {
    ...
    static createInterface(): MovableCollateralRouterInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): MovableCollateralRouter;
}
//# sourceMappingURL=MovableCollateralRouter__factory.d.ts.map