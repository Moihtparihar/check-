...
(function (IsmTypes) {
    ...
    IsmTypes["MerkleRootMultisigISM"] = "/hyperlane.core.interchain_security.v1.MerkleRootMultisigISM";
    IsmTypes["MessageIdMultisigISM"] = "/hyperlane.core.interchain_security.v1.MessageIdMultisigISM";
    IsmTypes["RoutingISM"] = "/hyperlane.core.interchain_security.v1.RoutingISM";
})(IsmTypes || (IsmTypes = {}));
...
export function setupInterchainSecurityExtension(base) {
    ...
    return {
        interchainSecurity: {
            AnnouncedStorageLocations: (req) => queryService.AnnouncedStorageLocations(req),
            LatestAnnouncedStorageLocation: (req) => queryService.LatestAnnouncedStorageLocation(req),
