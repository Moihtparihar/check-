...
type ISM = isTypes.NoopISM | isTypes.MerkleRootMultisigISM | isTypes.MessageIdMultisigISM | isTypes.RoutingISM;
...
export interface InterchainSecurityExtension {
    readonly interchainSecurity: {
        ...
        /** DecodedIsms ... */
        readonly DecodedIsms: <T = ISM>(req: isQuery.QueryIsmsRequest) => Promise<QueryDecodedIsmsResponse<T>>;
        /** DecodedIsm ... */
        readonly DecodedIsm: <T = ISM>(req: isQuery.QueryIsmRequest) => Promise<QueryDecodedIsmResponse<T>>;
    };
}
