...
export class SigningHyperlaneModuleClient extends SigningStargateClient {
    ...
    async createRoutingIsm(value, options) {
        const msg = {
    ...
    async setRoutingIsmDomain(value, options) {
        const msg = {
    ...
    async removeRoutingIsmDomain(value, options) {
        const msg = {
    ...
    async updateRoutingIsmOwner(value, options) {
        const msg = {
