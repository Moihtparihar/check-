...
export declare class SigningHyperlaneModuleClient extends SigningStargateClient {
    ...
    createRoutingIsm(value: Omit<isTx.MsgCreateRoutingIsm, 'creator'>, options?: TxOptions): Promise<TxResponse<isTx.MsgCreateRoutingIsmResponse>>;
    setRoutingIsmDomain(value: Omit<isTx.MsgSetRoutingIsmDomain, 'owner'>, options?: TxOptions): Promise<TxResponse<isTx.MsgSetRoutingIsmDomainResponse>>;
    removeRoutingIsmDomain(value: Omit<isTx.MsgRemoveRoutingIsmDomain, 'owner'>, options?: TxOptions): Promise<TxResponse<isTx.MsgRemoveRoutingIsmDomainResponse>>;
    updateRoutingIsmOwner(value: Omit<isTx.MsgUpdateRoutingIsmOwner, 'owner'>, options?: TxOptions): Promise<TxResponse<isTx.MsgUpdateRoutingIsmOwnerResponse>>;
