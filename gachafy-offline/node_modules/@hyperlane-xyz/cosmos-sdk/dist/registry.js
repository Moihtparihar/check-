...
export const COSMOS_MODULE_MESSAGE_REGISTRY = {
    ...
    MsgSetRoutingIsmDomain: {
        proto: {
            type: '/hyperlane.core.interchain_security.v1.MsgSetRoutingIsmDomain',
            converter: types.isTx.MsgSetRoutingIsmDomain,
        },
        amino: {
            type: 'hyperlane/v1/MsgSetRoutingIsmDomain',
        },
    },
    ...
    MsgRemoveRoutingIsmDomain: {
        proto: {
            type: '/hyperlane.core.interchain_security.v1.MsgRemoveRoutingIsmDomain',
    ...
    MsgUpdateRoutingIsmOwner: {
        proto: {
            type: '/hyperlane.core.interchain_security.v1.MsgUpdateRoutingIsmOwner',
