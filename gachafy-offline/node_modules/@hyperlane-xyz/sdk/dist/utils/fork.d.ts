 ...
 */
export declare const impersonateAccount: (address: Address, anvilEndPoint?: string) => Promise<providers.JsonRpcSigner>;
/**
 * Stops account impersonation.
 * @param address the address to stop impersonating
 */
export declare const stopImpersonatingAccount: (address: Address, anvilEndPoint?: string) => Promise<void>;
/**
 ...
 */
export declare const getLocalProvider: ({ anvilIPAddr, anvilPort, urlOverride, }?: {
    anvilIPAddr?: string | undefined;
