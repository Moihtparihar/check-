...
import { LOCKBOX_STANDARDS, MINT_LIMITED_STANDARDS, TOKEN_COLLATERALIZED_STANDARDS, TOKEN_STANDARD_TO_PROVIDER_TYPE, TokenStandard, } from '../token/TokenStandard.js';
...
export class WarpCore {
    ...
    async getInterchainTransferFee({ originToken, destination, sender, }) {
        ...
        if (defaultQuote) {
            ...
            const quote = await hypAdapter.quoteTransferRemoteGas(destinationDomainId, sender, originToken.igpTokenAddressOrDenom);
