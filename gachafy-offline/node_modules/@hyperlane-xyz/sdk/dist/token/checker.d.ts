...
export declare class HypERC20Checker extends ProxiedRouterChecker<HypERC20Factories & ProxiedFactories, HypERC20App, HypTokenRouterConfig> {
    ...
    checkDecimalConsistency(chain: ChainName, hypToken: TokenRouter, chainDecimals: Record<ChainName, number | undefined>, decimalType: 'actual' | 'config', nonEmpty: boolean): void;
}
