...
describe('HypERC20Checker.checkDecimalConsistency', () => {
    function buildChecker(configMap) {
    ...
    it('does not add violation when decimals are uniform (unscaled)', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x1111111111111111111111111111111111111111'), chainDecimals, 'actual', true);
    ...
    it('does not add violation when decimals are non-uniform but correct scale is provided', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x2222222222222222222222222222222222222222'), chainDecimals, 'actual', true);
        expect(checker.violations).to.have.length(0);
    });
    it('adds violation when decimals are non-uniform and scale is incorrect/missing', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x3333333333333333333333333333333333333333'), chainDecimals, 'actual', true);
    ...
    it('adds violation when nonEmpty is true and all decimals are undefined', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x4444444444444444444444444444444444444444'), chainDecimals, 'actual', true);
        expect(checker.violations).to.have.length(1);
        expect(checker.violations[0].type).to.equal('TokenDecimalsMismatch');
    });
    it('adds violation when some chains define decimals and others do not (nonEmpty=false)', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x5555555555555555555555555555555555555555'), chainDecimals, 'config', false);
        expect(checker.violations).to.have.length(1);
        expect(checker.violations[0].type).to.equal('TokenDecimalsMismatch');
    });
    it('adds violation when some chains define decimals and others do not (nonEmpty=true)', () => {
        ...
        checker.checkDecimalConsistency(TestChainName.test1, dummyToken('0x6666666666666666666666666666666666666666'), chainDecimals, 'actual', true);
        expect(checker.violations).to.have.length(1);
        expect(checker.violations[0].type).to.equal('TokenDecimalsMismatch');
    });
});
