...
import { IHypCollateralFiatAdapter, IHypTokenAdapter, IHypVSXERC20Adapter, IHypXERC20Adapter, IMovableCollateralRouterAdapter, ITokenAdapter, IXERC20Adapter, IXERC20VSAdapter, InterchainGasQuote, RateLimitMidPoint, TransferParams, TransferRemoteParams, xERC20Limits } from './ITokenAdapter.js';
...
export declare class EvmHypCollateralAdapter extends EvmHypSyntheticAdapter implements IHypTokenAdapter<PopulatedTransaction>, IMovableCollateralRouterAdapter<PopulatedTransaction> {
    readonly chainName: ChainName;
    readonly multiProvider: MultiProtocolProvider;
    readonly addresses: {
        token: Address;
    ...
    getRebalanceQuotes(bridge: Address, domain: Domain, recipient: Address, amount: Numberish, isWarp: boolean): Promise<InterchainGasQuote[]>;
    /**
