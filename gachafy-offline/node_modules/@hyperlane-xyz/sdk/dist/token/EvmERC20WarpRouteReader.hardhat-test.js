...
import { ERC20Test__factory, ERC4626Test__factory, FiatTokenTest__factory, HypERC20__factory, ISafe__factory, Mailbox__factory, ProxyAdmin__factory, XERC20LockboxTest__factory, XERC20Test__factory, } from '@hyperlane-xyz/core';
import { buildArtifact as coreBuildArtifact } from '@hyperlane-xyz/core/buildArtifact.js';
import { ContractVerifier, ExplorerLicenseType, TestChainName, proxyAdmin, proxyImplementation, test3, } from '@hyperlane-xyz/sdk';
...
describe('ERC20WarpRouterReader', async () => {
    ...
    beforeEach(async () => {
        ...
        evmERC20WarpRouteReader = new EvmERC20WarpRouteReader(multiProvider, chain, 1, contractVerifier);
        deployer = new HypERC20Deployer(multiProvider);
    });
