...
export declare const RADIX_SUPPORTED_TOKEN_TYPES: readonly [TokenType.collateral, TokenType.synthetic];
...
export declare const PROTOCOL_TO_HYP_NATIVE_STANDARD: Record<ProtocolType, TokenStandard>;
export {};
