...
import { CosmJsNativeProvider, CosmJsProvider, CosmJsWasmProvider, EthersV5Provider, RadixProvider, SolanaWeb3Provider, StarknetJsProvider, TypedProvider } from '../providers/ProviderType.js';
...
export declare class BaseRadixAdapter extends BaseAppAdapter {
    readonly protocol: ProtocolType;
    getProvider(): RadixProvider['provider'];
}
/**
