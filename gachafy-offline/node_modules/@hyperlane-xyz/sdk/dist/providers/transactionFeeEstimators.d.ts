...
import { CosmJsNativeProvider, CosmJsNativeTransaction, CosmJsProvider, CosmJsTransaction, CosmJsWasmProvider, CosmJsWasmTransaction, EthersV5Provider, EthersV5Transaction, RadixProvider, RadixTransaction, SolanaWeb3Provider, SolanaWeb3Transaction, StarknetJsProvider, StarknetJsTransaction, TypedProvider, TypedTransaction, ViemProvider, ViemTransaction } from './ProviderType.js';
...
export declare function estimateTransactionFeeCosmJsNative({ transaction, provider, estimatedGasPrice, sender, senderPubKey, memo, }: {
...
export declare function estimateTransactionFeeStarknet({ transaction, provider, sender, }: {
