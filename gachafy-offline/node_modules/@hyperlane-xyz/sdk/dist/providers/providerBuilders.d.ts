...
import { CosmJsNativeProvider, CosmJsProvider, CosmJsWasmProvider, EthersV5Provider, ProviderType, RadixProvider, SolanaWeb3Provider, StarknetJsProvider, TypedProvider, ViemProvider, ZKSyncProvider } from './ProviderType.js';
...
export declare function defaultRadixProviderBuilder(_rpcUrls: RpcUrl[], network: string | number): RadixProvider;
