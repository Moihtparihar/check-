...
import { ContractFactory as ZKSyncContractFactory, Provider as ZKSyncProvider } from 'zksync-ethers';
...
export declare class MultiProvider<MetaExt = {}> extends ChainMetadataManager<MetaExt> {
     ...
     */
    handleDeploy<F extends ZKSyncContractFactory | ContractFactory>(chainNameOrId: ChainNameOrId, factory: F, params: Parameters<F['deploy']>, artifact?: ZKSyncArtifact): Promise<Awaited<ReturnType<F['deploy']>>>;
    /**
