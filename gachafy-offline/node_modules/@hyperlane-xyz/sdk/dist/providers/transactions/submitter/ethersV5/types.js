import { z } from 'zod';
import { ZBigNumberish, ZBytes32String, ZChainName, ZHash, } from '../../../../metadata/customZodTypes.js';
...
export const isJsonRpcSubmitterConfig = isCompliant(EV5JsonRpcTxSubmitterPropsSchema);
...
export const EvmIcaTxSubmitterPropsSchema = z.lazy(() => z.object({
...
export const EvmTimelockControllerSubmitterPropsSchema = z.lazy(() => z.object({
