...
export async function getSubmitterBuilder({ submissionStrategy, multiProvider, coreAddressesByChain, additionalSubmitterFactories, }) {
    const submitter = await getSubmitter(multiProvider, submissionStrategy.submitter, coreAddressesByChain, additionalSubmitterFactories);
...
const defaultSubmitterFactories = {
    ...
    [TxSubmitterType.INTERCHAIN_ACCOUNT]: (multiProvider, metadata, coreAddressesByChain) => {
    ...
    [TxSubmitterType.TIMELOCK_CONTROLLER]: (multiProvider, metadata, coreAddressesByChain) => {
        assert(metadata.type === TxSubmitterType.TIMELOCK_CONTROLLER, `Invalid metadata type: ${metadata.type}, expected ${TxSubmitterType.TIMELOCK_CONTROLLER}`);
 ...
 */
export async function getSubmitter(multiProvider, submitterMetadata, coreAddressesByChain, additionalSubmitterFactories = {}) {
