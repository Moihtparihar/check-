...
import { IsmConfigSchema, IsmType, STATIC_ISM_TYPES, } from './types.js';
...
export class CosmosNativeIsmModule extends HyperlaneModule {
    ...
    static async create({ chain, config, addresses, multiProvider, signer, }) {
        const module = new CosmosNativeIsmModule(multiProvider, {
            addresses: {
                ...addresses,
                deployedIsm: '',
            },
    ...
    async deploy({ config }) {
        ...
        switch (ismType) {
            ...
            default:
                throw new Error(`ISM type ${ismType} is not supported on Cosmos Native`);
        }
    }
