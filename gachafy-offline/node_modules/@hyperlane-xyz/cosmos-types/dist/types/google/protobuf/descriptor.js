...
export const DescriptorProto = {
    ...
    fromPartial(object) {
        ...
        message.extension_range =
            object.extension_range?.map((e) => DescriptorProto_ExtensionRange.fromPartial(e)) || [];
        message.oneof_decl =
        ...
        message.reserved_range =
            object.reserved_range?.map((e) => DescriptorProto_ReservedRange.fromPartial(e)) || [];
...
export const ExtensionRangeOptions = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.verification !== undefined &&
            ...
            writer
                .uint32(24)
                .int32(extensionRangeOptions_VerificationStateToNumber(message.verification));
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.uninterpreted_option =
            object.uninterpreted_option?.map((e) => UninterpretedOption.fromPartial(e)) || [];
        message.declaration =
    ...
    fromPartial(object) {
        ...
        message.options =
            object.options !== undefined && object.options !== null
                ...
                : undefined;
        message.reserved_range =
            object.reserved_range?.map((e) => EnumDescriptorProto_EnumReservedRange.fromPartial(e)) || [];
        message.reserved_name = object.reserved_name?.map((e) => e) || [];
        return message;
    },
};
...
export const MethodOptions = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.idempotency_level !== undefined &&
            ...
            writer
                .uint32(272)
                .int32(methodOptions_IdempotencyLevelToNumber(message.idempotency_level));
        }
        for (const v of message.uninterpreted_option) {
            UninterpretedOption.encode(v, writer.uint32(7994).fork()).ldelim();
        }
