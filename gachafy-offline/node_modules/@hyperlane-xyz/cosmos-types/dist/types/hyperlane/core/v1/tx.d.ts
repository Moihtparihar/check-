...
export declare const MsgCreateMailbox: {
    ...
    create<I extends {
        ...
        default_hook?: string | undefined;
        required_hook?: string | undefined;
    } & { [K in Exclude<keyof I, keyof MsgCreateMailbox>]: never; }>(base?: I | undefined): MsgCreateMailbox;
    fromPartial<I_1 extends {
        ...
        default_hook?: string | undefined;
        required_hook?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgCreateMailbox>]: never; }>(object: I_1): MsgCreateMailbox;
};
export declare const MsgCreateMailboxResponse: {
    encode(message: MsgCreateMailboxResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateMailboxResponse;
    ...
    create<I extends {
        ...
        id?: string | undefined;
    } & { [K in Exclude<keyof I, "id">]: never; }>(base?: I | undefined): MsgCreateMailboxResponse;
    fromPartial<I_1 extends {
        id?: string | undefined;
    } & {
        id?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, "id">]: never; }>(object: I_1): MsgCreateMailboxResponse;
};
export declare const MsgSetMailbox: {
    ...
    create<I extends {
        ...
        new_owner?: string | undefined;
        renounce_ownership?: boolean | undefined;
    } & { [K in Exclude<keyof I, keyof MsgSetMailbox>]: never; }>(base?: I | undefined): MsgSetMailbox;
    fromPartial<I_1 extends {
        owner?: string | undefined;
        mailbox_id?: string | undefined;
        default_ism?: string | undefined;
        ...
        new_owner?: string | undefined;
        renounce_ownership?: boolean | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgSetMailbox>]: never; }>(object: I_1): MsgSetMailbox;
};
export declare const MsgSetMailboxResponse: {
    encode(_: MsgSetMailboxResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetMailboxResponse;
    fromJSON(_: any): MsgSetMailboxResponse;
    toJSON(_: MsgSetMailboxResponse): unknown;
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I | undefined): MsgSetMailboxResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgSetMailboxResponse;
};
export declare const MsgProcessMessage: {
    ...
    create<I extends {
        ...
        metadata?: string | undefined;
        message?: string | undefined;
    } & { [K in Exclude<keyof I, keyof MsgProcessMessage>]: never; }>(base?: I | undefined): MsgProcessMessage;
    fromPartial<I_1 extends {
        mailbox_id?: string | undefined;
        relayer?: string | undefined;
        metadata?: string | undefined;
        ...
        metadata?: string | undefined;
        message?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgProcessMessage>]: never; }>(object: I_1): MsgProcessMessage;
};
export declare const MsgProcessMessageResponse: {
    encode(_: MsgProcessMessageResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgProcessMessageResponse;
    fromJSON(_: any): MsgProcessMessageResponse;
    toJSON(_: MsgProcessMessageResponse): unknown;
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I | undefined): MsgProcessMessageResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgProcessMessageResponse;
};
...
export interface Msg {
    ...
    /** ProcessMessage ... */
    ProcessMessage(request: MsgProcessMessage): Promise<MsgProcessMessageResponse>;
}
