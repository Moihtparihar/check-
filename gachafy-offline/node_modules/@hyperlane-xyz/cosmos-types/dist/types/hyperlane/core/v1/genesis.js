...
export const GenesisState = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.ism_genesis !== undefined) {
            GenesisState1.encode(message.ism_genesis, writer.uint32(10).fork()).ldelim();
        }
        if (message.post_dispatch_genesis !== undefined) {
            GenesisState2.encode(message.post_dispatch_genesis, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.post_dispatch_genesis = GenesisState2.decode(reader, reader.uint32());
                    continue;
                case 3:
                    if (tag !== 26) {
                        break;
    ...
    toJSON(message) {
        ...
        if (message.post_dispatch_genesis !== undefined) {
            obj.post_dispatch_genesis = GenesisState2.toJSON(message.post_dispatch_genesis);
        }
        if (message.mailboxes?.length) {
            obj.mailboxes = message.mailboxes.map((e) => Mailbox.toJSON(e));
        }
        if (message.messages?.length) {
            obj.messages = message.messages.map((e) => GenesisMailboxMessageWrapper.toJSON(e));
        }
        if (message.ism_sequence !== '0') {
    ...
    fromPartial(object) {
        ...
        message.messages =
            object.messages?.map((e) => GenesisMailboxMessageWrapper.fromPartial(e)) || [];
