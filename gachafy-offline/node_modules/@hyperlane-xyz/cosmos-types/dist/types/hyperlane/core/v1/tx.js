...
export class MsgClientImpl {
    ...
    CreateMailbox(request) {
        ...
        return promise.then((data) => MsgCreateMailboxResponse.decode(_m0.Reader.create(data)));
    }
    SetMailbox(request) {
        const data = MsgSetMailbox.encode(request).finish();
        const promise = this.rpc.request(this.service, 'SetMailbox', data);
        return promise.then((data) => MsgSetMailboxResponse.decode(_m0.Reader.create(data)));
    }
    ProcessMessage(request) {
        const data = MsgProcessMessage.encode(request).finish();
        const promise = this.rpc.request(this.service, 'ProcessMessage', data);
        return promise.then((data) => MsgProcessMessageResponse.decode(_m0.Reader.create(data)));
    }
}
