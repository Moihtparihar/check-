...
export declare const InterchainGasPaymaster: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): InterchainGasPaymaster;
    ...
    create<I extends {
        ...
        claimable_fees?: ({
            ...
            denom?: string | undefined;
            amount?: string | undefined;
        } & { [K in Exclude<keyof I["claimable_fees"][number], keyof Coin>]: never; })[] & { [K_1 in Exclude<keyof I["claimable_fees"], keyof {
            denom?: string | undefined;
            amount?: string | undefined;
        }[]>]: never; }) | undefined;
    } & { [K_2 in Exclude<keyof I, keyof InterchainGasPaymaster>]: never; }>(base?: I | undefined): InterchainGasPaymaster;
    fromPartial<I_1 extends {
        ...
        claimable_fees?: ({
            ...
            denom?: string | undefined;
            amount?: string | undefined;
        } & { [K_3 in Exclude<keyof I_1["claimable_fees"][number], keyof Coin>]: never; })[] & { [K_4 in Exclude<keyof I_1["claimable_fees"], keyof {
            denom?: string | undefined;
            amount?: string | undefined;
        }[]>]: never; }) | undefined;
    } & { [K_5 in Exclude<keyof I_1, keyof InterchainGasPaymaster>]: never; }>(object: I_1): InterchainGasPaymaster;
};
export declare const DestinationGasConfig: {
    ...
    create<I extends {
        ...
        gas_overhead?: string | undefined;
    } & { [K_1 in Exclude<keyof I, keyof DestinationGasConfig>]: never; }>(base?: I | undefined): DestinationGasConfig;
    fromPartial<I_1 extends {
        remote_domain?: number | undefined;
        gas_oracle?: {
            token_exchange_rate?: string | undefined;
        ...
        gas_overhead?: string | undefined;
    } & { [K_3 in Exclude<keyof I_1, keyof DestinationGasConfig>]: never; }>(object: I_1): DestinationGasConfig;
};
export declare const GasOracle: {
    ...
    create<I extends {
        ...
        token_exchange_rate?: string | undefined;
        gas_price?: string | undefined;
    } & { [K in Exclude<keyof I, keyof GasOracle>]: never; }>(base?: I | undefined): GasOracle;
    fromPartial<I_1 extends {
        token_exchange_rate?: string | undefined;
        gas_price?: string | undefined;
    } & {
        token_exchange_rate?: string | undefined;
        gas_price?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof GasOracle>]: never; }>(object: I_1): GasOracle;
};
export declare const MerkleTreeHook: {
    ...
    create<I extends {
        ...
        tree?: ({
            ...
            branch?: (Uint8Array[] & Uint8Array[] & { [K in Exclude<keyof I["tree"]["branch"], keyof Uint8Array[]>]: never; }) | undefined;
            count?: number | undefined;
        } & { [K_1 in Exclude<keyof I["tree"], keyof Tree>]: never; }) | undefined;
    } & { [K_2 in Exclude<keyof I, keyof MerkleTreeHook>]: never; }>(base?: I | undefined): MerkleTreeHook;
    fromPartial<I_1 extends {
        id?: string | undefined;
        mailbox_id?: string | undefined;
        owner?: string | undefined;
        ...
        tree?: ({
            ...
            branch?: (Uint8Array[] & Uint8Array[] & { [K_3 in Exclude<keyof I_1["tree"]["branch"], keyof Uint8Array[]>]: never; }) | undefined;
            count?: number | undefined;
        } & { [K_4 in Exclude<keyof I_1["tree"], keyof Tree>]: never; }) | undefined;
    } & { [K_5 in Exclude<keyof I_1, keyof MerkleTreeHook>]: never; }>(object: I_1): MerkleTreeHook;
};
export declare const Tree: {
    ...
    create<I extends {
        ...
        branch?: (Uint8Array[] & Uint8Array[] & { [K in Exclude<keyof I["branch"], keyof Uint8Array[]>]: never; }) | undefined;
        count?: number | undefined;
    } & { [K_1 in Exclude<keyof I, keyof Tree>]: never; }>(base?: I | undefined): Tree;
    fromPartial<I_1 extends {
        branch?: Uint8Array[] | undefined;
        count?: number | undefined;
    } & {
        branch?: (Uint8Array[] & Uint8Array[] & { [K_2 in Exclude<keyof I_1["branch"], keyof Uint8Array[]>]: never; }) | undefined;
        count?: number | undefined;
    } & { [K_3 in Exclude<keyof I_1, keyof Tree>]: never; }>(object: I_1): Tree;
};
export declare const NoopHook: {
    ...
    create<I extends {
        ...
        id?: string | undefined;
        owner?: string | undefined;
    } & { [K in Exclude<keyof I, keyof NoopHook>]: never; }>(base?: I | undefined): NoopHook;
    fromPartial<I_1 extends {
        id?: string | undefined;
        owner?: string | undefined;
    } & {
        id?: string | undefined;
        owner?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof NoopHook>]: never; }>(object: I_1): NoopHook;
};
