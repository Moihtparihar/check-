...
export const QueryDestinationGasConfigsResponse = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.destination_gas_configs.push(DestinationGasConfig.decode(reader, reader.uint32()));
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    fromJSON(object) {
        return {
            destination_gas_configs: globalThis.Array.isArray(object?.destination_gas_configs)
                ? object.destination_gas_configs.map((e) => DestinationGasConfig.fromJSON(e))
                : [],
            pagination: isSet(object.pagination)
                ? PageResponse.fromJSON(object.pagination)
                : undefined,
    ...
    toJSON(message) {
        ...
        if (message.destination_gas_configs?.length) {
            obj.destination_gas_configs = message.destination_gas_configs.map((e) => DestinationGasConfig.toJSON(e));
        }
        if (message.pagination !== undefined) {
            obj.pagination = PageResponse.toJSON(message.pagination);
        }
    ...
    fromPartial(object) {
        ...
        message.destination_gas_configs =
            object.destination_gas_configs?.map((e) => DestinationGasConfig.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? PageResponse.fromPartial(object.pagination)
                : undefined;
...
export const QueryMerkleTreeHooksResponse = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.merkle_tree_hooks.push(WrappedMerkleTreeHookResponse.decode(reader, reader.uint32()));
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    fromJSON(object) {
        return {
            merkle_tree_hooks: globalThis.Array.isArray(object?.merkle_tree_hooks)
                ? object.merkle_tree_hooks.map((e) => WrappedMerkleTreeHookResponse.fromJSON(e))
                : [],
            pagination: isSet(object.pagination)
                ? PageResponse.fromJSON(object.pagination)
                : undefined,
    ...
    toJSON(message) {
        ...
        if (message.merkle_tree_hooks?.length) {
            obj.merkle_tree_hooks = message.merkle_tree_hooks.map((e) => WrappedMerkleTreeHookResponse.toJSON(e));
        }
        if (message.pagination !== undefined) {
            obj.pagination = PageResponse.toJSON(message.pagination);
        }
    ...
    fromPartial(object) {
        ...
        message.merkle_tree_hooks =
            object.merkle_tree_hooks?.map((e) => WrappedMerkleTreeHookResponse.fromPartial(e)) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? PageResponse.fromPartial(object.pagination)
                : undefined;
...
export const QueryMerkleTreeHookResponse = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.merkle_tree_hook !== undefined) {
            WrappedMerkleTreeHookResponse.encode(message.merkle_tree_hook, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.merkle_tree_hook = WrappedMerkleTreeHookResponse.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    toJSON(message) {
        const obj = {};
        if (message.merkle_tree_hook !== undefined) {
            obj.merkle_tree_hook = WrappedMerkleTreeHookResponse.toJSON(message.merkle_tree_hook);
        }
        return obj;
    },
    create(base) {
...
export const WrappedMerkleTreeHookResponse = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.merkle_tree !== undefined) {
            TreeResponse.encode(message.merkle_tree, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
export class QueryClientImpl {
    ...
    Igps(request) {
        ...
        return promise.then((data) => QueryIgpsResponse.decode(_m0.Reader.create(data)));
    }
    Igp(request) {
        const data = QueryIgpRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'Igp', data);
        return promise.then((data) => QueryIgpResponse.decode(_m0.Reader.create(data)));
    }
    DestinationGasConfigs(request) {
        const data = QueryDestinationGasConfigsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'DestinationGasConfigs', data);
        return promise.then((data) => QueryDestinationGasConfigsResponse.decode(_m0.Reader.create(data)));
    }
    QuoteGasPayment(request) {
        ...
        return promise.then((data) => QueryQuoteGasPaymentResponse.decode(_m0.Reader.create(data)));
    }
    MerkleTreeHooks(request) {
        ...
        return promise.then((data) => QueryMerkleTreeHooksResponse.decode(_m0.Reader.create(data)));
    }
    MerkleTreeHook(request) {
        ...
        return promise.then((data) => QueryMerkleTreeHookResponse.decode(_m0.Reader.create(data)));
    }
    NoopHooks(request) {
        const data = QueryNoopHooksRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'NoopHooks', data);
        return promise.then((data) => QueryNoopHooksResponse.decode(_m0.Reader.create(data)));
    }
    NoopHook(request) {
        const data = QueryNoopHookRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, 'NoopHook', data);
        return promise.then((data) => QueryNoopHookResponse.decode(_m0.Reader.create(data)));
    }
}
