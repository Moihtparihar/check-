...
function createBaseMsgSetIgpOwner() {
    return { owner: '', igp_id: '', new_owner: '', renounce_ownership: false };
}
...
export const MsgSetDestinationGasConfig = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.destination_gas_config !== undefined) {
            DestinationGasConfig.encode(message.destination_gas_config, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.destination_gas_config = DestinationGasConfig.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    toJSON(message) {
        ...
        if (message.destination_gas_config !== undefined) {
            obj.destination_gas_config = DestinationGasConfig.toJSON(message.destination_gas_config);
        }
        return obj;
    },
    create(base) {
...
export class MsgClientImpl {
    ...
    CreateIgp(request) {
        ...
        return promise.then((data) => MsgCreateIgpResponse.decode(_m0.Reader.create(data)));
    }
    SetIgpOwner(request) {
        const data = MsgSetIgpOwner.encode(request).finish();
        const promise = this.rpc.request(this.service, 'SetIgpOwner', data);
        return promise.then((data) => MsgSetIgpOwnerResponse.decode(_m0.Reader.create(data)));
    }
    SetDestinationGasConfig(request) {
        const data = MsgSetDestinationGasConfig.encode(request).finish();
        const promise = this.rpc.request(this.service, 'SetDestinationGasConfig', data);
        return promise.then((data) => MsgSetDestinationGasConfigResponse.decode(_m0.Reader.create(data)));
    }
    PayForGas(request) {
        const data = MsgPayForGas.encode(request).finish();
        const promise = this.rpc.request(this.service, 'PayForGas', data);
        return promise.then((data) => MsgPayForGasResponse.decode(_m0.Reader.create(data)));
    }
    Claim(request) {
    ...
    CreateMerkleTreeHook(request) {
        ...
        const promise = this.rpc.request(this.service, 'CreateMerkleTreeHook', data);
        return promise.then((data) => MsgCreateMerkleTreeHookResponse.decode(_m0.Reader.create(data)));
    }
    CreateNoopHook(request) {
        ...
        return promise.then((data) => MsgCreateNoopHookResponse.decode(_m0.Reader.create(data)));
    }
}
