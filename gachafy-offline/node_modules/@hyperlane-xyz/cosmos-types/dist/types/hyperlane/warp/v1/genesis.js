...
export const GenesisState = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.remote_routers.push(GenesisRemoteRouterWrapper.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            remote_routers: globalThis.Array.isArray(object?.remote_routers)
                ? object.remote_routers.map((e) => GenesisRemoteRouterWrapper.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.remote_routers?.length) {
            obj.remote_routers = message.remote_routers.map((e) => GenesisRemoteRouterWrapper.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.remote_routers =
            object.remote_routers?.map((e) => GenesisRemoteRouterWrapper.fromPartial(e)) || [];
        return message;
    },
};
...
export const GenesisRemoteRouterWrapper = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.remote_router !== undefined) {
            RemoteRouter.encode(message.remote_router, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
