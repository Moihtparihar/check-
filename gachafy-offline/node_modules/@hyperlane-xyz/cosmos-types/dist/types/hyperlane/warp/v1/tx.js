...
export const MsgEnrollRemoteRouter = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.remote_router !== undefined) {
            RemoteRouter.encode(message.remote_router, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
export class MsgClientImpl {
    ...
    CreateCollateralToken(request) {
        ...
        const promise = this.rpc.request(this.service, 'CreateCollateralToken', data);
        return promise.then((data) => MsgCreateCollateralTokenResponse.decode(_m0.Reader.create(data)));
    }
    CreateSyntheticToken(request) {
        const data = MsgCreateSyntheticToken.encode(request).finish();
        const promise = this.rpc.request(this.service, 'CreateSyntheticToken', data);
        return promise.then((data) => MsgCreateSyntheticTokenResponse.decode(_m0.Reader.create(data)));
    }
    SetToken(request) {
        const data = MsgSetToken.encode(request).finish();
        const promise = this.rpc.request(this.service, 'SetToken', data);
        return promise.then((data) => MsgSetTokenResponse.decode(_m0.Reader.create(data)));
    }
    EnrollRemoteRouter(request) {
        ...
        return promise.then((data) => MsgEnrollRemoteRouterResponse.decode(_m0.Reader.create(data)));
    }
    UnrollRemoteRouter(request) {
        ...
        return promise.then((data) => MsgUnrollRemoteRouterResponse.decode(_m0.Reader.create(data)));
    }
    RemoteTransfer(request) {
        ...
        return promise.then((data) => MsgRemoteTransferResponse.decode(_m0.Reader.create(data)));
    }
}
