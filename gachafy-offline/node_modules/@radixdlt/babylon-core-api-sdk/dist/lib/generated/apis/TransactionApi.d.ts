...
export declare class TransactionApi extends runtime.BaseAPI {
     ...
     */
    transactionPreviewV2PostRaw(requestParameters: TransactionPreviewV2PostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TransactionPreviewV2Response>>;
    /**
     * Previews a transaction against the latest network state, and returns the preview receipt. If the node has enabled it, you may be able to also preview against recent network state.  This endpoint supports V2 transactions (and beyond). If you still need to preview V1 transactions, you should use the `/preview` endpoint instead.
     * Transaction Preview V2
     */
    transactionPreviewV2Post(requestParameters: TransactionPreviewV2PostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TransactionPreviewV2Response>;
    /**
