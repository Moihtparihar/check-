 ...
 * @export
 */
export declare const TransactionPreviewV2ErrorResponseAllOfErrorTypeEnum: {
    readonly TransactionPreviewV2: "TransactionPreviewV2";
};
 ...
 */
export declare function instanceOfTransactionPreviewV2ErrorResponseAllOf(value: object): boolean;
export declare function TransactionPreviewV2ErrorResponseAllOfFromJSON(json: any): TransactionPreviewV2ErrorResponseAllOf;
export declare function TransactionPreviewV2ErrorResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionPreviewV2ErrorResponseAllOf;
export declare function TransactionPreviewV2ErrorResponseAllOfToJSON(value?: TransactionPreviewV2ErrorResponseAllOf | null): any;
