 ...
 * @export
 */
export declare const ParsedNotarizedTransactionV2AllOfTypeEnum: {
    readonly NotarizedTransactionV2: "NotarizedTransactionV2";
};
 ...
 */
export declare function instanceOfParsedNotarizedTransactionV2AllOf(value: object): boolean;
export declare function ParsedNotarizedTransactionV2AllOfFromJSON(json: any): ParsedNotarizedTransactionV2AllOf;
export declare function ParsedNotarizedTransactionV2AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedNotarizedTransactionV2AllOf;
export declare function ParsedNotarizedTransactionV2AllOfToJSON(value?: ParsedNotarizedTransactionV2AllOf | null): any;
